(function ($) {
  ...
  if ($(".parallax-scene-1").length) {
    parallaxInstance = new Parallax($(".parallax-scene-1").get(0));
  }
  if ($(".parallax-scene-2").length) {
    parallaxInstance = new Parallax($(".parallax-scene-2").get(0));
  }
  if ($(".parallax-scene-3").length) {
    parallaxInstance = new Parallax($(".parallax-scene-3").get(0));
  }
  if ($(".parallax-scene-4").length) {
    parallaxInstance = new Parallax($(".parallax-scene-4").get(0));
  }
  if ($(".parallax-scene-5").length) {
    parallaxInstance = new Parallax($(".parallax-scene-5").get(0));
  }
  ...
  if ($(".accordion-box").length) {
    $(".accordion-box").on("click", ".acc-btn", function () {
      ...
      if ($(this).next(".acc-content").is(":visible")) {
        ...
        $(this).next(".accordion").removeClass("active-block");
